 ...
 */
public class ShowAllTransactionsScene extends GridPane {
    ...
    public ShowAllTransactionsScene(AtmGuiApplication window){
        application = window;
        if(isFirst) {
    ...
    private void populateTransactions(){
        ArrayList<Transaction> cTransactions = transactionManager.getAllTransactions();
        String result = "";
